...
const EN: Record<string, string> = {
  'Visor HIBLOOMS': 'HIBLOOMS viewer',
  'Seguimiento actual': 'Current status',
  'Datos del proyecto': 'Project data',
  'Modelos y calibraciones': 'Models and calibrations',
  ...
  'Ver ficha del modelo': 'View model card',
  'Cargando modelos…': 'Loading models…',
  'Cada modelo se valida con datos independientes antes de publicarse en el visor. ¿Tienes medidas de tu embalse? Crea tu propio modelo en «Calibra tu embalse».': 'Each model is validated with independent data before it is published in the viewer. Have measurements from your reservoir? Build your own model in “Calibrate your reservoir”.',
  'Modelo': 'Model',
  'validado': 'validated',
  'Estima la concentración de clorofila-a (biomasa algal total) en la superficie del embalse a partir del índice NDCI de Sentinel-2.': 'Estimates chlorophyll-a concentration (total algal biomass) at the reservoir surface from the Sentinel-2 NDCI index.',
  'Error típico': 'Typical error',
  'R² (escala log)': 'R² (log scale)',
  'Clase trófica': 'Trophic class',
  'La predicción suele estar dentro de un factor 2 del valor real': 'The prediction is usually within a factor of 2 of the true value',
  'La predicción suele estar dentro de ese factor del valor real': 'The prediction is usually within that factor of the true value',
  'Proporción de la variación explicada': 'Share of variation explained',
  'Capacidad de distinguir episodios de más de 10 µg/L (0,5 = azar, 1 = perfecto)': 'Ability to tell apart episodes above 10 µg/L (0.5 = chance, 1 = perfect)',
  'Capacidad de distinguir episodios de más de 20 µg/L': 'Ability to tell apart episodes above 20 µg/L',
  'Aciertos de clase OCDE (oligo · meso · eutro · hipereutrófico)': 'Correct OECD class (oligo · meso · eu · hypereutrophic)',
  'Medido por la sonda': 'Measured by the probe',
  'Estimado por satélite': 'Satellite estimate',
  'Sonda': 'Probe',
  'Cada punto es una fecha con imagen y sonda a la vez; la estimación es la de validación (el modelo no había visto ese año). Línea discontinua: acierto perfecto. Recuadros: estado trófico (OCDE). Color: mes del año.': 'Each point is a date with both image and probe; the estimate is the validation one (the model had not seen that year). Dashed line: perfect match. Boxes: trophic state (OECD). Colour: month.',
  'Gráfico de validación no disponible todavía.': 'Validation chart not available yet.',
  'oligotrófico': 'oligotrophic',
  'mesotrófico': 'mesotrophic',
  'eutrófico': 'eutrophic',
  'hipereutrófico': 'hypereutrophic',
  'Datos de calibración': 'Calibration data',
  'pares imagen–sonda': 'image–probe pairs',
  'Validación': 'Validation',
  'Limitaciones': 'Limitations',
  'Ver en el visor': 'Open in viewer',
  'Sonda de perfiles Aquadam de la CHE (clorofila, 0–1,5 m)': 'CHE Aquadam profiling probe (chlorophyll, 0–1.5 m)',
  'Validación cruzada dejando fuera un año completo cada vez (el modelo nunca ve el año que predice)': 'Cross-validation leaving out one full year at a time (the model never sees the year it predicts)',
  'Se compararon regresión lineal y cuadrática, Lasso, bosque aleatorio y gradient boosting: ninguno mejoró de forma clara a esta fórmula, más sencilla y transparente.': 'Linear and quadratic regression, Lasso, random forest and gradient boosting were compared: none clearly beat this simpler, transparent formula.',
  'Estima la biomasa algal total: no distingue cianobacterias de otras algas.': 'Estimates total algal biomass: it does not distinguish cyanobacteria from other algae.',
  'Por debajo de ~7 µg/L no discrimina (aguas oligotróficas).': 'Below ~7 µg/L it does not discriminate (oligotrophic waters).',
  'Calibrado en El Val: en otros embalses es orientativo hasta validarlo con sus datos.': 'Calibrated at El Val: in other reservoirs it is indicative until validated with their data.',
  'modelos validados de la plataforma y calibración con tus propias medidas in situ, que se pinta como índice en el mapa.': 'validated platform models and calibration with your own in situ data, drawn as an index on the map.',
