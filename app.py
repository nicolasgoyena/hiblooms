    ...
    with row1[1]:
        ...
        if reservoir_name:
            ...
            if gdf is not None:
                ...
                max_cloud_percentage = st.slider("Dado que las nubes pueden alterar los valores estimados de concentraciones, es importante definir un límite máximo de nubosidad permitida. Es recomendable elegir valores de hasta el 20-25%, aunque si se quieren ver todas las imágenes disponibles, se puede aumentar la tolerancia:", 0, 100, 10)
